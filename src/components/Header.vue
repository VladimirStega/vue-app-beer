    ...
    <section class="section-header">
      <div class="container">
        <div class="header-btn">
          <router-link to="/" class="header-btn__link">
            <svg
              version="1.1"
              id="Capa_1"
          ...
          <router-link to="/" class="header-btn__link">
            ...
            >
              <g>
                <g>
                  <path
                    d="M584.995,221.946l-18.903-2.701l-23.297-2.023l-6.409-15.865l15.188-17.888l11.141-15.195
                  ...
                  />
                  <path
                    d="M306.166,201.357c-29.029,0-53.586,10.212-73.922,30.721c-20.171,20.336-30.382,44.893-30.382,73.583
          ...
          <div class="header-user__info">
            <ul class="header-user__list">
              <li class="header-user__item">
                <span class="header-user__number">15</span>
                <span class="header-user__descr">Likes</span>
              </li>
              <li class="header-user__item">
                <span class="header-user__number">92</span>
                <span class="header-user__descr">Dislikes</span>
              </li>
              <li class="header-user__item">
                <span class="header-user__number">187</span>
                <span class="header-user__descr">Followers</span>
              </li>
            </ul>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...mapGetters(["PROFILE_INFO"]),
    ...mapGetters(["BEER_INFO"]),
  },
  created() {},
};
</script>
